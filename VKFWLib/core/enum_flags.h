...
namespace vku {
    ...
    {
    public:
        EnumFlags() : mask_(static_cast<std::underlying_type<Enum>::type>(0)) {}
        EnumFlags(Enum bit) : mask_(static_cast<std::underlying_type<Enum>::type>(bit)) {}
    ...
    {
        return ~(EnumFlags<Enum>(static_cast<std::underlying_type<Enum>::type>(rhs)));
    }
}
